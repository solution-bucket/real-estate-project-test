...
<span style="display: flex; align-items: center; justify-content:center;">
    <p style="color:black;">Please contact</p>
 <figure class="author-thumb" style="color:blue; margin-left:10px; height:50px; border:4px solid #ddd; padding:2px; ">
    {{ $agent->name }}
    <img src="{{ (!empty($agent->photo)) ? url('upload/agent_images/'.$agent->photo) : url('upload/no_image.jpg') }}" alt="" style="width:40px; height:40px; border-radius:50%;" />
</figure>
</span>
</div>
