...
@section('title')
  {{ $property->property_name }} | Simple RealEstate
@endsection
...
<ul class="info clearfix">
    ...
    <li><span>State/county:</span> {{ $property['pstate']['state_name'] }}
  <img style="width:31px; height:20px" src="{{ asset($property['pstate']['state_image']) }}" alt="State / county info" srcset="">
...
<input type="hidden" name="agent_id" value="{{ $property->agent_id }}">
  @endif
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 column">
                        <div class="form-group">
                            <input type="time" name="tour_time" placeholder="Any Time">
                        </div>
                    </div>
