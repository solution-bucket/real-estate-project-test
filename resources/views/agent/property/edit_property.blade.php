                        ...
                        <form method="post" action="{{ route('agent.update.property') }}" id="myForm"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="state" class="form-select" id="exampleFormControlSelect1">
                                            ...
                                            <option value="{{ $state->id }}" {{ $state->id == $property->state ?
                                                'selected' : '' }}>{{ $state->state_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div><!-- Col -->
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="amenities_id[]" class="js-example-basic-multiple form-select"
                                            ...
                                            <option value="{{ $ameni->amenitis_name }}" {{ (in_array($ameni->
                                                amenitis_name,$property_ami)) ? 'selected' : '' }} >{{
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_descp" class="form-control" id="exampleFormControlTextarea1"
                                        rows="3">
 {{ $property->short_descp }}
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="long_descp" class="form-control" name="tinymce" id="tinymceExample"
                                        rows="10">
           {!! $property->long_descp !!}
                </textarea>
